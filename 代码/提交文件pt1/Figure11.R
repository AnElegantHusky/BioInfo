...
p = plotSM(data = logSoy, dataMetrics = scatMatMetrics, threshVar = "FDR", threshVal = 0.05, pointColor = colList[1+1], saveFile = FALSE)

p[["N_P"]] + xlab("Logged Count") + ylab("Logged Count") + ggtitle(paste("Cluster ", 1, " Significant Genes (n=", format(nGenes, big.mark=",", scientific=FALSE), ")",sep=""))
