...
p = plotSM(data = logSoy, dataMetrics = scatMatMetrics, threshVar = "FDR", threshVal = 0.05, pointColor = colList[4+1], saveFile = FALSE)

p[["N_P"]] + xlab("Logged Count") + ylab("Logged Count") + ggtitle(paste("Cluster ", 4, " Significant Genes (n=", format(nGenes, big.mark=",", scientific=FALSE), ")",sep=""))
